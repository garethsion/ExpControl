...
class Keysight_E5071C(VisaInstrument):
    ...
    def __init__(self, name, address, **kwargs):
        ...
        self.add_parameter('format3',
                           get_cmd='CALC:FORM',
                           vals=vals.Enum('MLOG','PHAS','GDEL','MLIN','SWR','REAL','IMAG','UPH'),
                           set_cmd=self._set_format3,
                           label='Trace ch2  format')
                           
        self.add_parameter('format4',
                           get_cmd='CALC:FORM',
                           vals=vals.Enum('MLOG','PHAS','GDEL','MLIN','SWR','REAL','IMAG','UPH'),
                           set_cmd=self._set_format4,
                           label='Trace ch2  format')
    ...
    def _set_format1(self,val):
       self.write('CALC1:FORM {}'.format(val))

    def _set_format2(self,val):
       self.write('CALC1:FORM {}'.format(val))
       
    def _set_format3(self,val):
       self.write('CALC1:FORM {}'.format(val))
       
    def _set_format4(self,val):
       self.write('CALC:FORM {}'.format(val))
    ...
    def initialise(self):
        ...
        self.write('CALC1:PAR:COUN 4') #add ampl 
